...
description: Learn how to create a custom chrome extension and use it to inject a custom React component into any site.
---

> This article was original posted on [myweekinjs](https://www.myweekinjs.com/chrome-extension-with-react)
